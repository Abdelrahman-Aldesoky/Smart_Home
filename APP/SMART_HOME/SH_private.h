...
#define CLEAR_NEWLINE_CHAR                                        \
	Local_u8User_input = USART_voidReceive();                     \
	if (Local_u8User_input == '\n' || Local_u8User_input == '\r') \
	Local_u8User_input = 0
...
#define SAVE_CURRENT_USERNAME_ADDRESS                                        \
...
#define SAVE_CURRENT_PASSWORD_ADDRESS                                        \
	JUMP_TO_CURR_USER_PASS_ADDRESS;                                          \
	Splitu16(Local_u16EEpromCurrentAdress, Local_u8EEpromCursorPositionArr); \
